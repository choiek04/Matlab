...
plot(meas(idx2,1), meas(idx2,2), 'go'); hold on; %versicolor는 녹색 동그라미로으로
...
%%학습데이터와 평가데이터 나누기
%두개의 그룹만 만저 나눠봅시다 versicolor vs. virginca
%오늘은 편의상 아래와 같이나누겠음
% 1~50: sttosa, 51~100: versicolor, 101~ `50: virginica
%학습데이터. 71~100: versicolor, 121~150: virginioca 총 60개
